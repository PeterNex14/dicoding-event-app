...
import com.gabsee.dicodingevents.databinding.FragmentUpcomingBinding
import com.gabsee.dicodingevents.ui.adapter.EventAdapter
import com.gabsee.dicodingevents.ui.viewmodel.UpcomingViewModel
...
class UpcomingFragment : Fragment() {
    ...
    private fun setupObservers() {
        viewModel.upcomingEvents.observe(viewLifecycleOwner) { event ->
    ...
    private fun setupRecyclerView() {
        adapter = EventAdapter (
            onItemClick = {
                val action = UpcomingFragmentDirections.actionNavigationUpcomingToDetailFragment(it.id)
